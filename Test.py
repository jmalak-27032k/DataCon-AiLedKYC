...
############UI started from here
# Function to open file dialog for uploading documents
...
def show_popup1():
    ...
    popup.title("Information Extracted")
...
content_frame = tk.Frame(root, bg="#C6E2FF")
content_frame.place(relx=0.13, rely=0.25, relwidth=0.35, relheight=0.5)
...
name_label = tk.Label(name_frame, text="Name", font=("Helvetica", 14),bg="#C6E2FF")
...
aadhar_upload_button = tk.Button(aadhar_frame, text="Upload Aadhar Card",command = lambda:upload_docs())
aadhar_upload_button.pack(side=tk.RIGHT, padx=10)

pan_label = tk.Label(pan_frame, text="PAN Card", font=("Helvetica", 14), bg="#C6E2FF")
pan_label.pack(side=tk.LEFT, padx=10)
pan_file_label = tk.Label(pan_frame, text="", font=("Helvetica", 12), bg="#C6E2FF")
pan_file_label.pack(side=tk.LEFT, padx=10)
pan_upload_button = tk.Button(pan_frame, text=" Upload PAN Card",command = lambda:upload_docs())
pan_upload_button.pack(side=tk.RIGHT, padx=10)

passport_label = tk.Label(passport_frame, text="Passport", font=("Helvetica", 14), bg="#C6E2FF")
passport_label.pack(side=tk.LEFT, padx=10)
passport_file_label = tk.Label(passport_frame, text="", font=("Helvetica", 12), bg="#C6E2FF")
passport_file_label.pack(side=tk.LEFT, padx=10)
passport_upload_button = tk.Button(passport_frame, text=" Upload Passport ",command = lambda:upload_docs())
...
close_button = tk.Button(button_frame, text="Close the App", font=("Helvetica", 14), command=root.quit)
close_button.pack(side=tk.RIGHT,padx=13)

# Submit Button
#show_popup
submit_button = tk.Button(button_frame, text="Submit", font=("Helvetica", 14), command=submit_docs)
submit_button.pack(side=tk.RIGHT,padx=11)

# capture Image Button
captureImage_button = tk.Button(button_frame, text="Capture Image", font=("Helvetica", 14),command = TrackImages)
captureImage_button.pack(side=tk.RIGHT,padx=11)
